...
func TestGenesis(t *testing.T) {
	...
	require.ElementsMatch(t, genesisState.OrdersExecutionReportList, got.OrdersExecutionReportList)
	require.Equal(t, genesisState.OrdersExecutionReportCount, got.OrdersExecutionReportCount)
