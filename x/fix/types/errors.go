...
var (
	...
	ErrWrongSessionIDInQuote              = sdkerrors.Register(ModuleName, 27, "This Session ID does not tally with the Quote Reques")
	...
	ErrQuoteRequestRejectReasonIsEmpty    = sdkerrors.Register(ModuleName, 29, "Quote Request Reject Reason is empty")
)
