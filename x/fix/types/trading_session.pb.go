...
func (m *TradingSession) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_e0d8ceb9122a9133 = []byte{
	...
	,
}
...
func (m *TradingSession) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		i = encodeVarintTradingSession(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func (m *TradingSession) Size() (n int) {
	...
	_ = l
	if m.Id != 0 {
		n += 1 + sovTradingSession(uint64(m.Id))
	}
	l = len(m.SessionID)
	if l > 0 {
