...
// source: re/fix/v1beta1/security_types.proto
...
func (*SecurityTypes) Descriptor() ([]byte, []int) {
	return fileDescriptor_94e74d894edee1db, []int{0}
}
...
func (*SecurityTypesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_94e74d894edee1db, []int{1}
}
...
func (*SecurityTypesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_94e74d894edee1db, []int{2}
}
...
func (*SecurityTypesRequestReject) Descriptor() ([]byte, []int) {
	return fileDescriptor_94e74d894edee1db, []int{3}
}
...
func init() {
	proto.RegisterType((*SecurityTypes)(nil), "re.fix.SecurityTypes")
	proto.RegisterType((*SecurityTypesRequest)(nil), "re.fix.SecurityTypesRequest")
	proto.RegisterType((*SecurityTypesResponse)(nil), "re.fix.SecurityTypesResponse")
	proto.RegisterType((*SecurityTypesRequestReject)(nil), "re.fix.SecurityTypesRequestReject")
}

func init() {
	proto.RegisterFile("re/fix/v1beta1/security_types.proto", fileDescriptor_94e74d894edee1db)
}

var fileDescriptor_94e74d894edee1db = []byte{
	// 594 bytes of a gzipped FileDescriptorProto
	,
}
