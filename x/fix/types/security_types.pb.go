...
func (m *SecurityTypes) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_f4d1877af2355937 = []byte{
	...
	0xcb, 0xac, 0xd0, 0x2f, 0x4e, 0x4d, 0x2e, 0x2d, 0xca, 0x2c, 0xa9, 0x8c, 0x2f, 0xa9, 0x2c, 0x48,
	0x2d, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xcd, 0xca, 0xcc, 0x35, 0xb6, 0x30, 0xd0,
	0x2b, 0x4a, 0xd5, 0x4b, 0xcb, 0xac, 0x50, 0xb2, 0xe5, 0xe2, 0x0d, 0x86, 0x2a, 0x0b, 0x01, 0xa9,
	...
	0x4a, 0xfd, 0xa0, 0x54, 0xfd, 0x0a, 0xb0, 0xc3, 0xc0, 0xee, 0x49, 0x62, 0x03, 0x3b, 0xc8, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0x1d, 0x3c, 0x18, 0x8f, 0xaf, 0x00, 0x00, 0x00,
}
...
func (m *SecurityTypes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		i = encodeVarintSecurityTypes(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func (m *SecurityTypes) Size() (n int) {
	...
	_ = l
	if m.Id != 0 {
		n += 1 + sovSecurityTypes(uint64(m.Id))
	}
	l = len(m.SessionID)
	if l > 0 {
