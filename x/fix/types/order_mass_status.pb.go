...
// source: re/fix/v1beta1/order_mass_status.proto
...
func (*OrderMassStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_10d0e98687cc7a7b, []int{0}
}
...
func (*OrderMassStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_10d0e98687cc7a7b, []int{1}
}
...
func (*OrderMassStatusReport) Descriptor() ([]byte, []int) {
	return fileDescriptor_10d0e98687cc7a7b, []int{2}
}
...
func (*OrderMassStatusRequestReject) Descriptor() ([]byte, []int) {
	return fileDescriptor_10d0e98687cc7a7b, []int{3}
}
...
func init() {
	proto.RegisterFile("re/fix/v1beta1/order_mass_status.proto", fileDescriptor_10d0e98687cc7a7b)
}

var fileDescriptor_10d0e98687cc7a7b = []byte{
	// 596 bytes of a gzipped FileDescriptorProto
	,
}
