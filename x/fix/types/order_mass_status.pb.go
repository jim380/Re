...
func (m *OrderMassStatus) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_cb28608e864d313c = []byte{
	...
	0xb6, 0x30, 0xd0, 0x2b, 0x4a, 0xd5, 0x4b, 0xcb, 0xac, 0x50, 0xb2, 0xe7, 0xe2, 0xf7, 0x07, 0xa9,
	0xf4, 0x4d, 0x2c, 0x2e, 0x0e, 0x06, 0xab, 0x13, 0xe2, 0xe3, 0x62, 0xca, 0x4c, 0x91, 0x60, 0x54,
	...
	0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xc4, 0x52, 0xfd, 0xa0, 0x54, 0xfd, 0x0a, 0xb0, 0xeb, 0x4a,
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x4e, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xc2,
	0x9b, 0xff, 0x61, 0xb4, 0x00, 0x00, 0x00,
}
...
func (m *OrderMassStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		i = encodeVarintOrderMassStatus(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func (m *OrderMassStatus) Size() (n int) {
	...
	_ = l
	if m.Id != 0 {
		n += 1 + sovOrderMassStatus(uint64(m.Id))
	}
	l = len(m.SessionID)
	if l > 0 {
