...
func (suite *KeeperTestSuite) TestMarketDataSnapshotFullRefresh() {
	...
	tests := []struct {
		...
		{
			"Valid Market Data Snapshot Full Refresh",
			args{
				session: types.Sessions{
					SessionID: "sessionID",
					LogonInitiator: &types.LogonInitiator{
...
func (suite *KeeperTestSuite) TestMarketDataRequestReject() {
	type args struct {
		session                    types.Sessions
		msgMarketDataRequestReject types.MsgMarketDataRequestReject
		marketData                 types.MarketData
	}
	...
	tests := []struct {
		...
		{
			"Valid Market Data Request Reject",
			args{
				session: types.Sessions{
					SessionID: "sessionID",
					LogonInitiator: &types.LogonInitiator{
				...
				msgMarketDataRequestReject: *types.NewMsgMarketDataRequestReject(suite.address[1].String(), "sessionID", "MdReqID", 3, "text"),
				marketData: types.MarketData{
					SessionID: "sessionID",
					MarketDataRequest: &types.MarketDataRequest{
						Header: &types.Header{
		...
		{
			"Market Data Request creator address is the same responding to the Market Data Request Reject",
			args{
				session: types.Sessions{
					SessionID: "sessionID",
					LogonInitiator: &types.LogonInitiator{
				...
				msgMarketDataRequestReject: *types.NewMsgMarketDataRequestReject(suite.address[0].String(), "sessionID", "MdReqID", 3, "text"),
				marketData: types.MarketData{
					SessionID: "sessionID",
					MarketDataRequest: &types.MarketDataRequest{
						Header: &types.Header{
		...
		},
		{
			...
			args{
				...
				msgMarketDataRequestReject: *types.NewMsgMarketDataRequestReject(suite.address[2].String(), "sessionID", "MdReqID", 3, "text"),
				marketData: types.MarketData{
					SessionID: "sessionID",
					MarketDataRequest: &types.MarketDataRequest{
						Header: &types.Header{
		...
		},
		{
			...
			args{
				...
				msgMarketDataRequestReject: *types.NewMsgMarketDataRequestReject(suite.address[1].String(), "sessionIDwbwbefufg", "MdReqID", 3, "text"),
				marketData: types.MarketData{
					SessionID: "sessionID",
					MarketDataRequest: &types.MarketDataRequest{
						Header: &types.Header{
	...
	for _, tc := range tests {
		suite.Run(tc.name, func() {
			...
			// set market data
			suite.fixKeeper.SetMarketData(suite.ctx, tc.args.marketData.MarketDataRequest.MdReqID, tc.args.marketData)
			// call market data request reject method
			res, err := suite.msgServer.MarketDataRequestReject(sdk.WrapSDKContext(suite.ctx), &tc.args.msgMarketDataRequestReject)
