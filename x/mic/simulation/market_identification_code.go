...
func SimulateMsgUpdateMarketIdentificationCode(
	ak types.AccountKeeper,
	bk types.BankKeeper,
	k keeper.Keeper,
) simtypes.Operation {
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		var (
			...
			msg                         = &types.MsgUpdateMarketIdentificationCode{}
			allMarketIdentificationCode = k.GetAllMarketIdentificationCode(ctx)
			found                       = false
		)
		for _, obj := range allMarketIdentificationCode {
			simAccount, found = FindAccount(accs, obj.Creator)
			if found {
				marketIdentificationCode = obj
				break
			}
		}
		if !found {
...
func SimulateMsgDeleteMarketIdentificationCode(
	ak types.AccountKeeper,
	bk types.BankKeeper,
	k keeper.Keeper,
) simtypes.Operation {
