...
var (
	...
	pattern_Query_Sessions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"jim380", "Re", "fix", "sessions", "sessionID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SessionsAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"jim380", "Re", "fix", "sessions"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SessionReject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "session", "reject", "sessionID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SessionRejectAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "session", "rejects"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SessionLogout_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "session", "logout", "sessionID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SessionLogoutAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "session", "logouts"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"jim380", "Re", "fix", "orders", "clOrdID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"jim380", "Re", "fix", "orders"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersCancelRequest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"jim380", "Re", "fix", "orders", "cancel", "request", "clOrdID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersCancelRequestAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"jim380", "Re", "fix", "orders", "cancel", "requests"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersCancelReject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"jim380", "Re", "fix", "orders", "cancel", "reject", "clOrdID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersCancelRejectAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"jim380", "Re", "fix", "orders", "cancel", "rejects"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersExecutionReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"jim380", "Re", "fix", "orders", "execution", "report", "clOrdID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrdersExecutionReportAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"jim380", "Re", "fix", "orders", "execution", "reports"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Quote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"jim380", "Re", "fix", "quote", "quoteReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QuotesBySessionID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"jim380", "Re", "fix", "quote", "sessionID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QuoteAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"jim380", "Re", "fix", "quotes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TradeCapture_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "trade", "capture", "tradeReportID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TradeCaptureAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "trade", "captures"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MarketData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "market", "data", "mdReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MarketDataAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "market", "data"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Security_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "security", "definition", "securityReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "security", "definition"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrderMassStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"jim380", "Re", "fix", "order", "mass", "status", "massStatusReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrderMassStatusAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"jim380", "Re", "fix", "order", "mass", "status"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TradingSession_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "trading", "session", "tradSesReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TradingSessionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "trading", "session"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TradingSessionList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"jim380", "Re", "fix", "trading", "session", "list", "tradSesReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TradingSessionListAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"jim380", "Re", "fix", "trading", "session", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "security", "list", "securityReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityListAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "security", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "security", "status", "securityStatusReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityStatusAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "security", "status"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityTypes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"jim380", "Re", "fix", "security", "types", "securityReqID"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SecurityTypesAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "security", "types"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_AccountRegistrationAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"jim380", "Re", "fix", "account", "registration"}, "", runtime.AssumeColonVerbOpt(false)))
)
